...
\todo{Maybe describe our own approach briefly, because has to be part of paper (see feedback from Alex): What are the key components of our approach and how does it differ to related work?}
...
\todo{ECSS as own "chapter"}
\todo{add industrial part for ECSS and current state of the art}
